 ...
 quotesWithAuthors = [
  ...
  { quote: "Science is organized knowledge.", author: "--Herbert Spencer" },
  { quote: "Patience is the key to paradise.", author: "--Turkish Proverb" },
  { quote: "Time is the most valuable thing a man can spend.", author: "--Theophrastus" },
  { quote: "He who seeks shall find.", author: "--Sophocles" },
  { quote: "Health is the greatest gift.", author: "--Buddha" },
  ...
  { quote: "Knowledge lights up the mind.", author: "--Confucius" },
  { quote: "A sound mind in a sound body.", author: "--Juvenal" },
  { quote: "Never put off till tomorrow what you can do today.", author: "--Benjamin Franklin" },
  { quote: "The world is a beautiful place if you know where to look.", author: "--Robert Frost" },
...
function getRandomQuote() {
  var randomIndex;
  do {
      randomIndex = Math.floor(Math.random() * quotesWithAuthors.length);
...
document.getElementById("asd").innerHTML = randomQuote.author;


console.log(quotesWithAuthors.length);
